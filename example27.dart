...
void main() {
  ...
  var fn = createFullName(firstName: "Nguyen", lastName: "Minh Nhat");
  print(fn);
...
// Sử dụng cú pháp rút gọn "=>" để viết hàm
...
// Hàm ẩn danh
// Trong dart rta có thể tạo hàm không có tên gọi là hàm ẩn danh, hay còn
// gọi là hàm lambda hoặc closure.
